                            ...
                            finalizedInvoices.length === 0 ? (
                                ...
                                <div className="flow-root">
                                    <ul role="list" className="-mb-8">
                                        {finalizedInvoices.map(
                                            (version, idx) => {
                                                return (
                                                    <li key={version.id}>
                                                        <div
                                                            className="group relative cursor-pointer pb-8"
                                                            onClick={() =>
                                                                router.get(
                                                                    route(
                                                                        'invoices.finalized.show',
                                                                        [
                                                                            invoice.id,
                                                                            version.id,
                                                                        ]
                                                        ...
                                                        >
                                                            ...
                                                            <div className="relative flex space-x-3">
                                                                <div>
                                                                    <span className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-400 ring-8 ring-white transition-colors group-hover:bg-indigo-500">
